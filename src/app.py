...
activities = {
    "Basketball Team": {
        "description": "Team practices and friendly matches to build basketball skills",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Soccer drills, scrimmages, and local competitions",
    ...
    "Debate Team": {
        "description": "Practice argumentation and compete in structured debates",
